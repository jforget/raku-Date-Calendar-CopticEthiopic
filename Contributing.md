...
[https://github.com/jforget/raku-Date-Calendar-CopticEthiopic]      and
create an issue.
...
directory as `Date::Calendar::CopticEthiopic`:
...
For this, from the `raku-Date-Calendar-CopticEthiopic` directory, run:
